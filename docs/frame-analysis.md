...
这个定位决定了它的独特性：它不是"帮你做事"的 skill，而是"帮你改变思考方式"的 skill。在本仓库现有的 skill 谱系中，它最接近 `dou-wentao-perspective`（思维顾问）和 `nuwa-skill`（思维框架提炼），但比前者更方法论化，比后者更偏向通用认知工具而非特定人物视角。
