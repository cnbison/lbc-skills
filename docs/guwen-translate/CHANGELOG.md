...
### Changed
- 修复 SKILL.md 与参考文件的层级冲突
  - 第3点"输出结构"：将"无论哪一流派，输出均包含以下模块"改为"输出以以下模块为参考框架，但不必强制填满"
  - 明确各典籍风格指南有权在具体诠释中取舍模块、调整深度
  - 与全部9部参考文件的"形式随气/势/文/卦而变"原则保持一致
  - 第4点"语气与质地约束"末尾补充："各典籍的具体质地追求以对应参考文件为准"
  - 涉及文件：`SKILL.md`
