...
**If "stdout" (default):**
Just output the digest directly. The deliver script also saves a copy to the current working directory at `output/follow-builders/ai-builders-digest-{YYYY-MM-DD}.md`.
