...
**Persona Forge destila la forma de pensar de cualquier persona. Haz que Musk, Naval, Munger y Feynman trabajen para ti.**
...
Solo ingresa un nombre: Persona Forge maneja la investigación, extracción y validación automáticamente.

[Ejemplos](#ejemplos) · [Instalación](#instalación) · [Qué destila Persona Forge](#qué-destila-nuwa) · [Cómo funciona](#cómo-funciona)
...
## Qué destila Persona Forge

Destilar las mejores mentes en cualquier campo requiere extraer algo más profundo que los hábitos de trabajo diarios. Persona Forge extrae seis capas:
...
Los hábitos de trabajo se pueden transmitir con documentos de proceso. Pero lo que hace que Munger y Musk lleguen a conclusiones diferentes sobre el mismo problema son sus marcos cognitivos. Persona Forge extrae el sistema operativo cognitivo.
...
Ingresa un nombre y Persona Forge hace cuatro cosas:
...
Persona Forge no copia personas. Extrae sistemas operativos cognitivos.

**Persona Forge (Persona Forge)**, la diosa en la mitología china que creó humanos de arcilla. Aquí la arcilla es información pública, y lo que se crea no es una persona — es un espejo.

---

## Sobre el autor

Huashu / Huasheng, AI Native Coder, desarrollador independiente. Todos los productos están construidos con código escrito por IA ([Kitten Fill Light](https://apps.apple.com/app/id6738028637) llegó al #1 en el chart de pago de App Store China). Ejecutando 40+ skills personalizados en Claude Code. Persona Forge es el skill que crea skills.
...
**Persona Forge** destila cómo una persona piensa.<br><br>
*La próxima persona que quieras destilar no tiene por qué ser un colega.*
